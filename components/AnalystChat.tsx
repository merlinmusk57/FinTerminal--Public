...
export const AnalystChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Good morning. I am your dedicated financial analyst AI. I have context on HSBC HK, Standard Chartered HK, BOC HK and Hang Seng financials. How can I assist with your peer analysis today?', timestamp: new Date() }
  ]);
